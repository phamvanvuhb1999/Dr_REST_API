...
//update profile
router.patch('/friends', tokerMiddleware, function(req, res, next) {
...
router.patch('/conversations/', tokerMiddleware, function(req, res, next) {
    const user_data = req.userData;
...
router.patch('/informations/', tokerMiddleware, function(req, res, next) {
    const form = req.body;
    const user_data = req.userData;
    Profile.findOne({ userId: user_data.userId })
        .exec()
...
//delete profile
router.delete('/:profile', tokerMiddleware, function(req, res, next) {
